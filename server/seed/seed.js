...
const leads = [
  ...
  {
    id: "ld_0917",
    captured_at: "2026-03-18T09:02:44Z",
    config_version: 1,
    name: "Bill Tanner",
...
const seedDatabase = async () => {
  try {
    ...
    await Configuration.create(configuration);

    await Lead.insertMany(leads);

    const hashedPassword = await bcrypt.hash("Northline@123", 10);
    ...
    console.log("Email: admin@northline.com");
    console.log("Password: Northline@123");
